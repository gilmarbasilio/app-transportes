...
export const registerService = async (data: RegisterServiceRequest): Promise<RegisterServiceResponse> => {
  try {
...
export const loginService = async (data: LoginServiceRequest): Promise<LoginServiceResponse> => {
  try {
